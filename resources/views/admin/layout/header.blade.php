...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ URL::to('public/website/assets/images/logo/logo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <!-- Preloader -->
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{ URL::to('public/website/assets/images/logo/logo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
