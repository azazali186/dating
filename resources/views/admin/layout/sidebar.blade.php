 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ URL::to('public/admin/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8 ">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
   <a href="{{url('admincon/allusers')}}" class="<?php if($pagename == 'all-user-list'){ echo "nav-link active";
            }
            else
            {
              echo "nav-link";
          ...
          <li class="nav-item">
                 <a href="{{url('admincon/allseller')}}" class="<?php if($pagename == 'all-seller-list'){ echo "nav-link active";
            }
            else
            {
              echo "nav-link";
